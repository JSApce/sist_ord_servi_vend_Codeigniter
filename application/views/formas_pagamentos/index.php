                        ...
                        <tbody>
                            <?php foreach ($formas_pagamentos as $forma): ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4"><?php echo ($forma->forma_pagamento_aceita_parc == 1 ? '<span class="badge badge-success btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>' ) ?></td>
                                    ...
                                    <td class="text-right">
                                        <a title="Editar" href="<?php echo base_url('formas_pagamentos/edit/' . $forma->forma_pagamento_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#forma-<?php echo $forma->forma_pagamento_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
