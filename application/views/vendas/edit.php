...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('vendas') ?>">Listar Vendas</a></li>
                                ...
                                <tbody id="lista_produtos" class="item">
                                    ...
                                    <?php foreach ($venda_produtos as $venda_produto): ?>
                                        ...
                                        <tr>                                                    
                                            ...
                                            <td class="text-center"><input type="hidden" name="valor_desconto_produto[]" data-cell="H<?php echo $i; ?>"  data-format="R$ 0,0.00" data-formula="((C<?php echo $i; ?>*D<?php echo $i; ?>)-F<?php echo $i; ?>)"><button title="<?php echo ($desabilitar == TRUE ? 'Produto vendido' : 'Remover o produto'); ?>" class="btn-remove btn btn-sm <?php echo ($desabilitar == TRUE ? 'btn-outline-success disabled' : 'btn-danger'); ?>" <?php echo ($desabilitar == TRUE ? 'disabled' : ''); ?>><i class="<?php echo ($desabilitar == TRUE ? 'fa fa-check' : 'fas fa-trash-alt'); ?>"></i></button></td>
                                        </tr>
