    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova venda" href="<?php echo base_url('vendas/add') ?>" class="btn btn-sm btn-success float-right"><i class="fas fa-shopping-cart"></i>&nbsp;Nova</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php foreach ($vendas as $venda): ?>
                                ...
                                <!-- Logout Modal-->
                            <div class="modal fade" id="servico-<?php echo $venda->venda_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
