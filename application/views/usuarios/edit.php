            ...
            <div class="card-body">
                <form  class="user" method="POST" name="form_edit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <label >Ativo</label>
                            <select class="form-control custom-select" name="active" <?php echo(!$this->ion_auth->is_admin() ? 'disabled' : '') ?> >
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control custom-select" name="perfil_usuario" <?php echo(!$this->ion_auth->is_admin() ? 'disabled' : '') ?>>
