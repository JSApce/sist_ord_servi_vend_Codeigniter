                            ...
                            <div class="col-md-4">
                                ...
                                <select class="custom-select" name="produto_fornecedor_id">
                                   <?php foreach ($fornecedores as $fornecedore): ?>
                                        <option value="<?php echo $fornecedore->fornecedor_id ?>" <?php echo ($fornecedore->fornecedor_id == $produto->produto_fornecedor_id ? 'selected' : '') ?>><?php echo $fornecedore->fornecedor_nome_fantasia ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
