    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo produto" href="<?php echo base_url('produtos/add') ?>" class="btn btn-sm btn-success float-right"><i class="fas fa-plus "></i>&nbsp;Novo</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php foreach ($produtos as $produto): ?>
                                ...
                                <!-- Logout Modal-->
                            <div class="modal fade" id="servico-<?php echo $produto->produto_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
