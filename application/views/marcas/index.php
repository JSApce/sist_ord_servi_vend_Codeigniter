                            ...
                            <?php foreach ($marcas as $marca): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#servico-<?php echo $marca->marca_id ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                                    </td>
                                </tr>
