...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('marcas') ?>">Marcas cadastradas</a></li>
                ...
                <form  class="user" method="POST" name="form_edit">
                    ...
                    <fieldset class="mt-4 border p-2">
                        <legend class="font-small">
                            <i class="fas fa-cubes"></i>&nbsp;Dados da marca
                        </legend>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label >Ativo</label>
                                <select class="custom-select" name="marca_ativo">
