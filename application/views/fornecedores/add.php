                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user sp_celphones" name="fornecedor_telefone" value="<?php echo  set_value('fornecedor_telefone'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label >Celular</label>
                                <input type="text" class="form-control form-control-user sp_celphones" name="fornecedor_celular" value="<?php echo  set_value('fornecedor_celular'); ?>">
