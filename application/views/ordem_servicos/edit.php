                                    ...
                                    <?php if (isset($os_tem_servicos)): ?>
                                        ...
                                        <?php foreach ($os_tem_servicos as $os_servico): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="hidden" name="valor_desconto_servico[]" data-cell="H<?php echo $i; ?>"  data-format="R$ 0,0.00" data-formula="((C<?php echo $i; ?>*D<?php echo $i; ?>)-F<?php echo $i; ?>)"><button title="<?php echo ($ordem_servico->ordem_servico_status == 1 ? 'Servico concluído' : 'Remover o servico'); ?>" class="btn-remove btn btn-sm <?php echo ($ordem_servico->ordem_servico_status == 1 ? 'btn-outline-success disabled' : 'btn-danger'); ?>" <?php echo ($ordem_servico->ordem_servico_status == 1 ? 'disabled' : ''); ?>><i class="<?php echo ($ordem_servico->ordem_servico_status == 1 ? 'fa fa-check' : 'fas fa-trash-alt'); ?> "></i></button></td>
                                            </tr>
